...
const min_neighbor_vf_sketch = (p, sketch_name) => {
    const arg = {
        screen: {
            w: 720,
            h: 480,
...
export default min_neighbor_vf_sketch;
