...
import { update_vectorfield } from '../vectorfield-blogpost/src/common/vectorfield_function.js';
...
const vf_sobel_sketch = (p, sketch_name) => {
    const arg = {
        screen: {
            w: 720,
            h: 480,
    ...
    p.setup = () => {
        ...
        update_vectorfield(p, node_grid, arg);
    }
...
export default vf_sobel_sketch;